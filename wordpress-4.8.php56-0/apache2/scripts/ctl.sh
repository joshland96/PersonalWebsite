...
HTTPD_PIDFILE=/Applications/wordpress-4.8.php56-0/apache2/logs/httpd.pid



HTTPD="/Applications/wordpress-4.8.php56-0/apache2/bin/httpd -f /Applications/wordpress-4.8.php56-0/apache2/conf/httpd.conf"
if [ -f "/Applications/wordpress-4.8.php56-0/apps/bitnami/banner/disable-banner" ] ; then
...
. /Applications/wordpress-4.8.php56-0/apache2/bin/envvars
